...
Policy report reinforcement note, 2026-08-03 (supersedes 2026-07-25): the policy corpus was expanded to a unified domestic-foreign collection of 85,001 records (13,476 Korean, 71,525 foreign and international-organisation). All reported statistics use the analysis sample of 37,082 L3-mapped records (9,560 Korean, 27,522 foreign incl. 10,617 international-organisation). For 2022-2026, the reference policy space contains 475 L3 topics (472 active in the foreign corpus, 465 active in Korea). Korea has 9 absolute gaps (1.9%) and 253 positive shortfall topics with a summed shortfall of 26.25 percentage points; 111 topics are under-represented (ratio r below 0.50). The top shortfall topics are Environmental sustainability, Employment impacts, Labour market transition, Gender bias, and Gender equality. The earlier estimate of 121 absolute gaps (26.6% of a 455-topic observed space) was based on the smaller 15,040-record collection and is retained only as a historical reference; the collapse of absolute gaps is largely a function of collection depth. 2026 records are partial-year observations.
